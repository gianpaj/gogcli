...
type SlidesCmd struct {
	...
	ReplaceText        SlidesReplaceTextCmd        `cmd:"" name:"replace-text" help:"Replace text in a presentation, optionally limited to a specific slide/page"`
	ReplaceTextBatch   SlidesReplaceTextBatchCmd   `cmd:"" name:"replace-text-batch" help:"Replace multiple text strings in a presentation, optionally limited to a specific slide/page"`
